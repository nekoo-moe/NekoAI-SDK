...
export interface ExtensionIdentity {
  /**
   * Stable extension identifier from `extension.nekoai.json`.
   */
  id: string
  /**
...
export enum WebSocketEventSource {
  Server = 'proj-nekoai:server-runtime',
  StageWeb = 'proj-nekoai:stage-web',
  StageTamagotchi = 'proj-nekoai:stage-tamagotchi',
}
