# @nekotech/plugin-protocol

Shared protocol contracts for plugin-module communication in Project NekoAI.
...
```ts
import type { WebSocketEvent, WebSocketEventOf, WebSocketEvents } from '@nekotech/plugin-protocol/types'

import { moduleAnnounce, moduleAuthenticate } from '@nekotech/plugin-protocol/types'
```
