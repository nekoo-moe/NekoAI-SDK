 ...
 */
export const protocolCapabilityWaitEventName = 'proj-nekoai:plugin-sdk:apis:protocol:capabilities:wait'
/**
 ...
 */
export const protocolCapabilitySnapshotEventName = 'proj-nekoai:plugin-sdk:apis:protocol:capabilities:snapshot'
/**
