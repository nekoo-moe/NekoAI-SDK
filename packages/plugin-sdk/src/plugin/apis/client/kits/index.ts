 ...
 */
export const pluginKitApiListEventName = 'proj-nekoai:plugin-sdk:apis:client:kits:list'
/**
 ...
 */
export const pluginKitApiGetCapabilitiesEventName = 'proj-nekoai:plugin-sdk:apis:client:kits:get-capabilities'
/**
 ...
 */
export const pluginKitRegistryResourceKey = 'proj-nekoai:plugin-sdk:resources:kits'
