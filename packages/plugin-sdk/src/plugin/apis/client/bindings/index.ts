 ...
 */
export const pluginBindingApiListEventName = 'proj-nekoai:plugin-sdk:apis:client:bindings:list'
/**
 ...
 */
export const pluginBindingApiAnnounceEventName = 'proj-nekoai:plugin-sdk:apis:client:bindings:announce'
/**
 ...
 */
export const pluginBindingApiActivateEventName = 'proj-nekoai:plugin-sdk:apis:client:bindings:activate'
/**
 ...
 */
export const pluginBindingApiUpdateEventName = 'proj-nekoai:plugin-sdk:apis:client:bindings:update'
/**
 ...
 */
export const pluginBindingApiWithdrawEventName = 'proj-nekoai:plugin-sdk:apis:client:bindings:withdraw'
/**
 ...
 */
export const pluginBindingRegistryResourceKey = 'proj-nekoai:plugin-sdk:resources:bindings'
...
export function getKitBindingResourceKey(kitId: string) {
  return `proj-nekoai:plugin-sdk:resources:kits:${kitId}:bindings`
}
