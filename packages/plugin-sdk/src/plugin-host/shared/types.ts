...
} from '@nekotech/plugin-protocol/types'
...
export interface ExtensionManifestV1 {
  ...
  apiVersion: 'v1'
  /** Manifest kind discriminator used to identify NekoAI extension manifests. */
 ...
 *
 * Use when:
 * - Parsing `extension.nekoai.json` before loading an extension into the host
 *
 * Expects:
 ...
 *
 * Returns:
 * - A Valibot schema for the NekoAI extension manifest format
 */
