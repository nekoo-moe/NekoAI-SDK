...
The NekoAI ecosystem is moving toward:
...
NekoAI plugin orchestration should behave like an extensible runtime kernel:
...
- [NekoAI Plugin Platform](./architecture.md)
