...
4. Click **Add Local Plugin** and select your project's root folder containing `plugins.json`.
...
1. Ensure your `package.json` specifies `"files"` including `"plugins.json"`, `"dist"`, and `"README.md"`:
   ```json
   {
