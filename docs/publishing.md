...
4. Click **Add Local Plugin** and select your project's root folder containing `neko-plugin.json`.
...
1. Ensure your `package.json` specifies `"files"` including `"neko-plugin.json"`, `"dist"`, and `"README.md"`:
   ```json
   {
